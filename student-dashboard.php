...
$job_count = $job_count_result->fetch_assoc()['count'];
...
$shortlisted_query = "SELECT COUNT(*) as count FROM applications WHERE student_id = ? AND status = 'shortlisted'";
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Student Dashboard</h2>
                    <div>
                        <span class="badge bg-info">Hall Ticket: <?php echo $student['hall_ticket']; ?></span>
                    </div>
                </div>
                ...
                <?php if ($student['status'] != 'approved'): ?>
                    <div class="alert alert-warning">
                        ...
                        Your account is pending approval. You will be able to access all features once approved by admin.
                    </div>
                <?php endif; ?>
                ...
                <div class="row mb-4">
                    <div class="col-xl-3 col-md-6 mb-4">
                        <div class="card border-left-primary shadow h-100 py-2">
                            ...
                            <div class="card-footer bg-transparent">
                                <a href="student-jobs.php" class="text-decoration-none">
                    ...
                    <div class="col-xl-3 col-md-6 mb-4">
                        <div class="card border-left-success shadow h-100 py-2">
                            ...
                            <div class="card-footer bg-transparent">
                                <a href="student-applied.php" class="text-decoration-none">
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                            Account Status</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo ucfirst($student['status']); ?></div>
                                    </div>
                                    <div class="col-auto">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <?php
                                $recent_apps_query = "SELECT a.*, j.title, c.name as company_name 
                                                     FROM applications a 
                                ...
                                if ($recent_apps->num_rows > 0) {
                                    while ($app = $recent_apps->fetch_assoc()) {
                                        ...
                                        echo '<small class="text-muted">' . $app['company_name'] . '</small>';
                                        echo '</div>';
                            ...
                            <div class="card-footer bg-transparent text-center">
                                <a href="student-applied.php" class="text-decoration-none">View All Applications</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="card shadow">
                            <div class="card-header bg-light">
                                <h6 class="mb-0">Latest Job Opportunities</h6>
                            </div>
                            <div class="card-body">
                                <?php
                                ...
                                if ($recent_jobs->num_rows > 0) {
                                    while ($job = $recent_jobs->fetch_assoc()) {
                                        ...
                                        echo '<small class="text-muted">' . $job['company_name'] . ' • ' . $job['work_mode'] . '</small>';
                                        echo '<div class="mt-1">';
                                        echo '<span class="badge bg-light text-dark">' . $job['employment_type'] . '</span>';
                                        echo '<span class="badge bg-light text-dark ms-1">' . $job['salary'] . '</span>';
                                        echo '</div>';
                                        echo '</div>';
                                    }
                                } else {
                                    echo '<p class="text-muted">No job opportunities available.</p>';
                                }
                                ?>
                            </div>
                            <div class="card-footer bg-transparent text-center">
                                <a href="student-jobs.php" class="text-decoration-none">Browse All Jobs</a>
                            </div>
                        </div>
                    </div>
                </div>
